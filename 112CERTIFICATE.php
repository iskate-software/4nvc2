...
<table width="100%" height="553" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <iframe src="CERTIFICATE_IFRAME.php?species=<?php echo $_GET['species']; ?>&certifpetid=<?php echo $_GET['certifpetid']; ?>&certname=<?php echo $_GET['certname']; ?>" scrolling="no" width="725px" height="450" frameborder="0" name="cert_iframe" id="cert_iframe" >
    </iframe>
    </td>
    </tr>
    </table>    </td>
  ...
  <tr>
    <td height="35" colspan="5" align="center" valign="middle" bgcolor="#B1B4FF">
     ...
     <input name="print" class="button" type="button" value="PRINT" onclick="cert_iframe.print();"/>
