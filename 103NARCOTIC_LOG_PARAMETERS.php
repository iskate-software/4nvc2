...
<title>NARCOTIC LOG PARAMETERS</title>
<!-- InstanceEndEditable -->
...
<form name="narcotic_log" method="get" action="NARCOTIC_LOG_REPORT.php" >
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="void" rules="cols">
          <tr>
            <td width="46%" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="35" align="center" valign="bottom" class="Verdana12"><strong><u>REPORT SEQUENCE</u></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio" value="1" checked="checked"/>
                  Chronologically</label></td>
              </tr>
              <tr>
                <td height="30" align="left" class="Verdana12">
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio2" value="2" />
                  By Narcotic</label></td>
              </tr>
              <tr>
                <td height="30" align="left" class="Verdana12">
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio3" value="3" />
                  Single Patient</label></td>
              </tr>
              <tr>
